...
func TestComputeFileDiff_AddedFile(t *testing.T) {
	...
	diff, err := ComputeFileDiff(repo, "", newHash, "test.txt")
	if err != nil {
...
func TestComputeFileDiff_DeletedFile(t *testing.T) {
	...
	diff, err := ComputeFileDiff(repo, oldHash, "", "test.txt")
	if err != nil {
		t.Fatalf("ComputeFileDiff failed: %v", err)
	}
...
func TestComputeFileDiff_ModifiedLines(t *testing.T) {
	...
	// Compute diff
	diff, err := ComputeFileDiff(repo, oldHash, newHash, "test.txt")
	if err != nil {
		t.Fatalf("ComputeFileDiff failed: %v", err)
	}
...
func TestComputeFileDiff_BinaryFile(t *testing.T) {
	...
	// Compute diff
	diff, err := ComputeFileDiff(repo, "", binaryHash, "binary.bin")
	if err != nil {
		t.Fatalf("ComputeFileDiff failed: %v", err)
	}
...
func TestComputeFileDiff_LargeFile(t *testing.T) {
	...
	// Compute diff
	diff, err := ComputeFileDiff(repo, "", largeHash, "large.txt")
	if err != nil {
		t.Fatalf("ComputeFileDiff failed: %v", err)
	}
